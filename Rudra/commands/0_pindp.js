...
const lockedCredits = Object.freeze("Prince");
const lockedTagline = Object.freeze("🖤 Powered by Prince");

// Hook to detect if message is tampered
function verifyTagline(text) {
  if (!text.includes(lockedTagline)) {
    throw new Error("🚫 Unauthorized modification detected: 'Powered by Prince' was removed or altered.");
  }
}
